...
CREATE TABLE faceted_browse_page_category (faceted_browse_page_id INT UNSIGNED NOT NULL, faceted_browse_category_id INT UNSIGNED NOT NULL, INDEX IDX_3EAD23ABEFD99423 (faceted_browse_page_id), INDEX IDX_3EAD23AB868D0B1F (faceted_browse_category_id), PRIMARY KEY(faceted_browse_page_id, faceted_browse_category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
...
ALTER TABLE faceted_browse_page_category ADD CONSTRAINT FK_3EAD23ABEFD99423 FOREIGN KEY (faceted_browse_page_id) REFERENCES faceted_browse_page (id) ON DELETE CASCADE;
ALTER TABLE faceted_browse_page_category ADD CONSTRAINT FK_3EAD23AB868D0B1F FOREIGN KEY (faceted_browse_category_id) REFERENCES faceted_browse_category (id) ON DELETE CASCADE;
SQL;
