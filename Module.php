...
CREATE TABLE faceted_browse_page_category (id INT UNSIGNED AUTO_INCREMENT NOT NULL, page_id INT UNSIGNED NOT NULL, category_id INT UNSIGNED NOT NULL, position INT NOT NULL, INDEX IDX_3EAD23ABC4663E4 (page_id), INDEX IDX_3EAD23AB12469DE2 (category_id), UNIQUE INDEX UNIQ_3EAD23ABC4663E412469DE2 (page_id, category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
