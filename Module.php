...
CREATE TABLE faceted_browse_page_category (page_id INT UNSIGNED NOT NULL, category_id INT UNSIGNED NOT NULL, INDEX IDX_3EAD23ABC4663E4 (page_id), INDEX IDX_3EAD23AB12469DE2 (category_id), PRIMARY KEY(page_id, category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB;
...
ALTER TABLE faceted_browse_page_category ADD CONSTRAINT FK_3EAD23ABC4663E4 FOREIGN KEY (page_id) REFERENCES faceted_browse_page (id);
ALTER TABLE faceted_browse_page_category ADD CONSTRAINT FK_3EAD23AB12469DE2 FOREIGN KEY (category_id) REFERENCES faceted_browse_category (id);
SQL;
