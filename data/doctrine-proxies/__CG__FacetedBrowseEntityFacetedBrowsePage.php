 ...
 */
class FacetedBrowsePage extends \FacetedBrowse\Entity\FacetedBrowsePage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FacetedBrowsePage $proxy) {
