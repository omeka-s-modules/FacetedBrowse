...
class FacetedBrowseCategoryAdapter extends AbstractEntityAdapter
{
    ...
    public function hydrate(Request $request, EntityInterface $entity, ErrorStore $errorStore)
    {
        ...
        if ($this->shouldHydrate($request, 'o-module-faceted_browse:value_facet_mode')) {
            $entity->setValueFacetMode($request->getValue('o-module-faceted_browse:value_facet_mode'));
        }
